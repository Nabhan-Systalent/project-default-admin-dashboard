...
const Page2 = lazy(() => import('./pages/story-8/index'));
  ...
  return (
    <BrowserRouter>
      <div style={{ fontFamily: 'system-ui, sans-serif', minHeight: '100vh', background: '#f9fafb' }}>
        <nav style={NAV_STYLE}>
          <Link to="/" style={ACTIVE_STYLE}>User Directory</Link>
          <Link to="/workflows" style={LINK_STYLE}>Workflows</Link>
          <Link to="/reports" style={LINK_STYLE}>Financials</Link>
        </nav>
        <main style={{ padding: '2rem 1.5rem', maxWidth: 1024, margin: '0 auto' }}>
          <Suspense fallback={<p>Loading…</p>}>
            <Routes>
              <Route path="/" element={<Page0 />} />
              <Route path="/workflows" element={<Page1 />} />
              <Route path="/reports" element={<Page2 />} />
